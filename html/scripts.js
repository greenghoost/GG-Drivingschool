...
$(".btnQuestion").click(function () {
	$.post('http://GG-Drivingschool/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('http://GG-Drivingschool/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://GG-Drivingschool/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
document.getElementById("drivingSchoolTitle").innerText = "DRIVING SCHOOL";
document.getElementById("drivingSchoolTitle2").innerText = "© _GreenGhost";
